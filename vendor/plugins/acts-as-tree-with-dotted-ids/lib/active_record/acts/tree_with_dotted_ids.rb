...
#--------------kalpit 27/05/2011-----------------------------------------------
        def all_children_del
          find_all_children_with_dotted_ids_del
        end
...
#--------------kalpit-----------------------------------------------
      ...
      protected
        ...
        #--------------kalpit 27/05/2011-----------------------------------------------
        def find_all_children_with_dotted_ids_del(prefix = nil, options = {})
          self.class.find_with_deleted(:all, options.update(:conditions => ['dotted_ids LIKE ?', dotted_id_like_pattern(prefix)]))
        end
        #--------------kalpit-----------------------------------------------
